    ...
    <div class="container-fluid px-2 px-md-4 mt-5 pt-5">
        <div class="card card-body mx-3 mx-md-4 mt-n6 mt-5">
            ...
            <div class="row d-flex justify-content-center">
                <h2 class="text-center">Create a new coupon</h2>
                <div class="col-12 col-md-10 col-lg-9 col-xl-8">
                    <form method="POST" action="{{ route('admin.coupons.store') }}">
                        ...
                        <div class="input-group input-group-outline my-3 is-focused">
                            ...
                            <input id="coupon_value" name="coupon_value" type="text" class="form-control" value="{{ old('coupon_value') }}">
                        </div>

                        <div class="input-group input-group-outline my-3 is-focused">
                            <label for="coupon_max_users" class="form-label">Coupon Max Users</label>
                            <input id="coupon_max_users" name="coupon_max_users" type="text" class="form-control" value="{{ old('coupon_max_users') }}">
                        </div>

                        <div class="input-group input-group-outline my-3 is-focused">
                            <label for="coupon_expire_at" class="form-label">Coupon Expire at</label>
                            <input id="coupon_expire_at" name="coupon_expire_at" type="date" class="form-control" value="{{ old('coupon_expire_at') }}">
                        </div>
                        <div class="form-check form-switch d-flex align-content-center">
                            <input class="form-check-input me-2" name="coupon_status" type="checkbox" id="coupon_status" checked>
                            <label class="form-check-label" for="coupon_status">Coupon Status</label>
                        </div>
                        <div class="input-group input-group-outline my-4 d-flex">
                            <input type="submit" class="btn btn-warning w-100 p-1 fs-6" value="Create">
                        </div>
                    </form>
                </div>
            </div>
