                ...
                <div class="col-12 col-md-10 col-lg-9 col-xl-8">
                    <form method="POST" action="{{ route('admin.cities.store') }}">
                        ...
                        <div class="input-group input-group-outline my-3 is-focused">
                            ...
                            <input id="city_name" name="city_name" type="text" class="form-control" value="{{ old('city_name') }}">
                        </div>

                        <div class="input-group input-group-outline my-3 is-focused">
                            <label for="city_price" class="form-label">City Price</label>
                            <input id="city_price" name="city_price" type="text" class="form-control" value="{{ old('city_price') }}">
                        </div>

                        <div class="input-group input-group-outline my-4 d-flex">
                            <input type="submit" class="btn btn-dark w-100 p-1 fs-6" value="Create">
                        </div>
                    </form>
                </div>
            </div>
