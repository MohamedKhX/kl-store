                ...
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1">
                            <p class="text-sm mb-0 text-capitalize">All product Views</p>
                            <h4 class="mb-0">{{ $productViews }}</h4>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1">
                            ...
                            <h4 class="mb-0">{{ $todayOrdersCount }}</h4>
                        </div>
                    </div>
                    <hr class="dark horizontal my-0">
                    <div class="card-footer p-3">
                ...
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1">
                            ...
                            <h4 class="mb-0">{{ $todaySales }} LYD</h4>
                        </div>
                    </div>
                    <hr class="dark horizontal my-0">
                    <div class="card-footer p-3">
                ...
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1">
                            ...
                            <h4 class="mb-0">{{ $totalSales }} LYD</h4>
                        </div>
                    </div>
                    <hr class="dark horizontal my-0">
                    <div class="card-footer p-3">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex px-2 py-1">
                                            <div>
                                                <img src="{{ asset('/img/Dashboard/small-logos/logo-xd.svg') }}" class="avatar avatar-sm me-3" alt="xd">
                                            </div>
