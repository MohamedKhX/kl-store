...
@auth()
    <a style="cursor: pointer" class="text-1000" href="{{ route('dashboard') }}">
...
@endauth
<div style="cursor: pointer" class="text-1000 position-relative" data-bs-toggle="modal" data-bs-target="#CartModel">
