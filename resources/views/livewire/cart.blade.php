                    ...
                    @else
                        @foreach($cartItems as $item)
                            <div class="d-flex justify-content-between my-3">
                                ...
                                <div class="d-flex row justify-content-between align-content-between me-1" style="width: 70%">
                                    <div class="d-flex justify-content-between px-0">
                                        <h6 class="px-2 py-1">{{ $item->name }}</h6>
                                        <h6 class="px-2 py-1">{{ $item->price }} LYD</h6>
                                    </div>
                                    <div class="px-0 mb-2">
                                        <div class="px-2 py-1 d-flex justify-content-between">
                                            <div class="quantity buttons_added mt-2">
                                                ...
                                                <input type="text"
                                                       onKeyDown="return false"
                                                       name="quantity" title="Qty"
                                                       class="input-text qty text py-1"
                                                       wire:model="qtys.{{$item->rowId}}"
                                                       style="height: 30px !important;"
                                                >
                                    ...
                                    <div class="d-flex justify-content-between px-0">
                                        <h7 class="px-2 mt-1">Size: {{ $item->options->size }}</h7>
                                        <div class="px-2">
                                            <a wire:click="deleteItemFromCart('{{ $item->rowId }}')" style="cursor: pointer;">
                                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 48 48" style=" fill:#undefined;">
...
{{-- start old code for small screen show--}}
{{--
<div class="col-12 my-3 d-xl-none">
    <div class="row d-flex justify-content-center">
        @if(count($cartItems) <= 0)
